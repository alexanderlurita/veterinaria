...
(
    ...
    tipocliente		CHAR(1)			NOT NULL DEFAULT 'E', -- Estandar - Administrador
	dni				CHAR(8) 		NOT NULL,
...
INSERT INTO clientes (apellidos, nombres, tipocliente, dni, claveacceso) VALUES
	('Lurita', 'Alexander', 'A', '73790885', '$2y$10$U1S.7fB0CNrdIeH4L7kTaeiNa2vdiFfR8P1UJSzSnCjIVyVkEFGSi'),
	('Perez', 'Fernanda', 'E', '21304010', '$2y$10$ZkFhCk.PMnzU/XqW5Y97EuMXIyvr5SAWt86u9y0WdOp/7GEloCrFi'),
	('Magallanes', 'Luis', 'E', '72456021', '$2y$10$vW3p1QXxN//4opYNHCRfo.e28G71qmabv3VK5d3J4HHdjFCx5FUs.');
